...
__turbopack_context__.s({
    ...
    "isCompressedAndEncoded": (()=>isCompressedAndEncoded)
});
...
async function decodeAndDecompress(encoded) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pako$2f$dist$2f$pako$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].inflate(compressed, {
        to: 'string'
    });
}
function isCompressedAndEncoded(s) {
...
const generateMockPortrait = (photoDataUri)=>{
...
function PortraitGeneratorForm() {
    ...
    const applyWatermarkAndConvertToJpeg = (dataUri)=>{
    ...
    const handleShare = async ()=>{
        ...
        try {
            const watermarkedUri = await applyWatermarkAndConvertToJpeg(generatedPortraitUri);
            const compressedData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$url$2d$compression$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["compressAndEncode"])(watermarkedUri);
            ...
            if (navigator.share && navigator.canShare(shareData)) {
                ...
                toast({
                    title: 'Link Copied!',
                    description: 'Sharing is not supported on this browser. The link has been copied to your clipboard.'
                });
            }
        } catch (error) {
            if (error.name !== 'AbortError') {
                toast({
                    title: 'Share Failed',
                    description: 'Could not prepare share link. Please try again.',
                    variant: 'destructive'
                });
            }
        }
...
//# sourceMappingURL=src_6fea2536._.js.map